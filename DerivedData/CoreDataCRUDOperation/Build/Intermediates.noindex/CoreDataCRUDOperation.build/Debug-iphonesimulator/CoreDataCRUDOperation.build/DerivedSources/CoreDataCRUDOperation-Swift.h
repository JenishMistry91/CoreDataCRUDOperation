...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="CoreDataCRUDOperation",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC21CoreDataCRUDOperation11AppDelegate")
...
SWIFT_CLASS("_TtC21CoreDataCRUDOperation13SceneDelegate")
...
@interface User (SWIFT_EXTENSION(CoreDataCRUDOperation))
...
SWIFT_CLASS("_TtC21CoreDataCRUDOperation14ViewController")
@interface ViewController : UIViewController
@property (nonatomic, weak) IBOutlet UITableView * _Null_unspecified tblView;
- (void)viewDidLoad;
- (IBAction)btnAddTapepd:(id _Nonnull)sender;
...
@interface ViewController (SWIFT_EXTENSION(CoreDataCRUDOperation)) <UITableViewDataSource>
- (NSInteger)tableView:(UITableView * _Nonnull)tableView numberOfRowsInSection:(NSInteger)section SWIFT_WARN_UNUSED_RESULT;
- (UITableViewCell * _Nonnull)tableView:(UITableView * _Nonnull)tableView cellForRowAtIndexPath:(NSIndexPath * _Nonnull)indexPath SWIFT_WARN_UNUSED_RESULT;
@end


@interface ViewController (SWIFT_EXTENSION(CoreDataCRUDOperation)) <UITableViewDelegate>
